...
public class AgendaEventos {
    ...
    public void exibirAgenda() {
        ...
        for (Map.Entry<LocalDate, Evento> entry : eventosTreeMap.entrySet()) {
            ...
            System.out.println(
                    "Data: " + dataEvento.format(formatter) + ", Evento: " + evento.getNome() + ", Atração: " + evento.getAtracao());
        }
    }
    ...
    public void obterProximoEvento() {
        ...
        if (proximoEvento != null) {
            System.out.println("O próximo evento '" + proximoEvento.getNome() + "' acontecerá em " + proximaData.format(formatter));
        } else {
