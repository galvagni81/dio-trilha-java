...
public class ConjuntoConvidados {
    ...
    public void adicionarConvidado(String nome, int codigoConvite) {
        System.out.println("Adicionando novo convidado \'" + nome + "\' à lista de convidados.");
        ...
        if (!convidadosSet.isEmpty()) {
            for (Convidado c : convidadosSet) {
                if (c.getCodigoConvite() == codigoConvite) {
                    System.out.println("Removendo o convidado \'" + c.getNome() + "\' da lista de convidados.");
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Há " + conjuntoConvidados.contarConvidados() + " convidado(s) na lista (Set) de Convidados");
        ...
        System.out.println("Há " + conjuntoConvidados.contarConvidados()
                + " convidado(s) dentro da lista (Set) de Convidados após a remoção.");
